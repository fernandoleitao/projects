...
O algoritmo bubble sort percorre a lista inteira no minimo uma vez antes de iniciar a ordenaçao.
Pelo que pesquisamos sobre este algoritmo, ele é considerado um método extremamente complexo, não 
sendo recomendado para programas que manipulem grande quantidade de dados e necessite de velocidade. 
Acreditamos que o objetivo maior dessa atividade é que cada conceito seja compreendido e possamos 
comparar um algoritmo com o outro e entender que dependendo da finalidade que se deseja é necessário
cautela na escolha do algoritmo e conhecimento exato de como se da seu funcionamento. 
Não cabe nesse momento descrever o conceito de cada algoritmo, mas sim nosso entendimento a respeito. 
A conclusao que tivemos, em termos de velocidade e processamento, os algoritmos que apresentarem melhor 
desempenho foram o ‘quicksort’,  counting sort e Merge sort, enquanto os algoritmos bubble Sort e 
Insertion Sort, quando aplicados a ordenaçao de grande quantidade de elementos não tiveram bom desempenho, 
consumiram grande quantidade de memoria e demandaram muito tempo de processamentos. Foi uma atividade 
com bastantes detalhes e temas a serem pesquisados. 
'''
